...
![Terraform](https://github.com/nclouds/terraform-aws-ec2/workflows/Terraform/badge.svg)
# nCode Library

## AWS Elastic Compute Cloud (EC2) Terraform Module

Terraform module to provision [`Ec2 Instances`](https://aws.amazon.com/ec2/) on AWS.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_common_tags"></a> [common\_tags](#module\_common\_tags) | github.com/nclouds/terraform-aws-common-tags | v0.1.4 |
...
| <a name="input_append_workspace"></a> [append\_workspace](#input\_append\_workspace) | appends the terraform workspace at the end of the identifier like <identifier>-<workspace> | `bool` | `true` | no |
| <a name="input_associate_eip_address"></a> [associate\_eip\_address](#input\_associate\_eip\_address) | Whether to associate an elastic IP to the instance | `bool` | `false` | no |
...
| <a name="input_eip_allocation_id"></a> [eip\_allocation\_id](#input\_eip\_allocation\_id) | elastic ip to associate to instance if not specified a new ip is reserved | `string` | `null` | no |
...
| <a name="input_identifier"></a> [identifier](#input\_identifier) | Identifier to name resources | `string` | n/a | yes |
