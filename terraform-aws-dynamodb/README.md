...
![Terraform](https://github.com/nclouds/terraform-aws-dynamodb/workflows/Terraform/badge.svg)
# nCode Library

## terraform-aws-dynamodb

Terraform code to create dynamodb related resources.
...
| <a name="input_identifier"></a> [identifier](#input\_identifier) | Name of the DynamoDB table | `string` | n/a | yes |
