...
variable "target_group_arns" {
  description = "a list of aws alb target groups ARNs to use with an ALB"
  default     = []
  type        = list(string)
}

variable "load_balancers" {
  description = "List of Load balancer names for autoscalling to add, for ALBs use target_group_arns"
  default     = []
  type        = list(string)
}
